...
class AppLocalizationsTr extends AppLocalizations {
  ...
  String app_about(Object appName) {
    return '$appName basitliği hedefleyen metin tabanlı bir not alma uygulamasıdır. Materyal Tasarımı benimser. Notları yerel olarak saklar ve internet izni yoktur, böylece notlara erişebilen tek kişi sizsiniz.notes.';
  }
  ...
  @override
  String get settings_export_json_description => 'Notları daha sonra kurtarabilmek için bir JSON dosyasına (çöp kutusu dahil) aktarın';

  @override
  String get settings_export_markdown_description => 'Notları markdown dosyasına (çöp kutusu dahil) aktarın';

  @override
  String get settings_export_success => 'Dışa aktarma başarıl';
  ...
  @override
  String get action_add_note => 'Not ekle';

  @override
  String get hint_title => 'Başlık';

  @override
  String get tooltip_fab_add_note => 'Not ekle';
  ...
  String dialog_delete_body(num count) {
    ...
    return 'Gerçekten $count $_temp0 silmek istiyor musunuz? $_temp1 çöp kutusundan kurtarabilirsiniz.';
  }
  ...
  String dialog_permanently_delete_body(num count) {
    ...
    return 'Gerçekten $count $_temp0 kalıcı olarak silmek istiyor musunuz? $_temp1 kurtaramayacaksınız.';
  }
